...
- `artifact_volume_name` (string) - Name for the cloned OS volume artifact.

- `artifact_volume_location_code` (string) - Location for a single cloned OS volume artifact. Defaults to location_code.

- `artifact_volume_location_codes` ([]string) - Locations for cloned OS volume artifacts. The first location becomes the primary artifact ID.
